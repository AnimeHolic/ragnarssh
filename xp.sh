...
# // Exporting URL Host
export Server_URL="raw.githubusercontent.com/AnimeHolic/ragnarssh/main/test"
export Server1_URL="raw.githubusercontent.com/AnimeHolic/ragnarssh/main/limit"
